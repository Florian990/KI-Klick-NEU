...
export default function QuizLandingPage() {
  ...
  const handleQuizComplete = (answers: QuizAnswers) => {
    ...
    trackEvent('funnel_qualified', { answers });
  };
  ...
  const handleFormSubmit = async (data: { name: string; email: string; countryCode: string; phone: string }) => {
    ...
    try {
      ...
      await apiRequest("POST", "/api/quiz-complete", {
        ...
        source: "Quiz Funnel",
        ...(testToken ? { test: true, testToken } : {}),
      });

      trackEvent('funnel_contact_submitted');
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full">
          <div className="mb-2 sm:mb-3 px-2 text-center">
            ...
            <p className="mt-2 sm:mt-3 text-sm sm:text-base md:text-lg text-muted-foreground font-medium">
              Beantworte 4 kurze Fragen und finde sofort heraus, ob du geeignet bist.
            </p>
          </div>
